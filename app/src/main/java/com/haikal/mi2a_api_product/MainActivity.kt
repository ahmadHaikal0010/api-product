package com.haikal.mi2a_api_product
...
import com.haikal.mi2a_api_product.adapter.ProdukAdapter
import com.haikal.mi2a_api_product.model.ModelProduk
import com.haikal.mi2a_api_product.model.ResponseProduk
import com.haikal.mi2a_api_product.service.APIClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun produkOnClick(modelProduk: ModelProduk) {
        Toast.makeText(
            applicationContext, modelProduk.description,
            Toast.LENGTH_SHORT
        ).show()
    }
